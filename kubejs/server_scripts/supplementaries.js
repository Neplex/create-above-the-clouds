...
ServerEvents.recipes((event) => {
  ...
  event.shaped("farmersdelight:rope", ["A", "A"], {
    A: "supplementaries:flax",
  });

  event.shaped("supplementaries:spring_launcher", ["AAA", "BCB", "BDB"], {
    A: "#minecraft:planks",
...
RecipeViewerEvents.removeEntriesCompletely("item", (event) => {
  event.remove("supplementaries:wrench");
