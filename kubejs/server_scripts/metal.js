ServerEvents.tags("item", (event) => {
  ...
  event.remove("overgeared:hot_items", "minecraft:lava_bucket");
  event.add("overgeared:heated_metals", "minecraft:lava_bucket");
  event.add("overgeared:heated_metals", /createmetallurgy\:molten_.*_bucket/);
  event.add("overgeared:heated_metals", /createbigcannons\:molten_.*_bucket/);
});
...
ServerEvents.tags("fluid", (event) => {
  ...
  event.add("c:fluids/molten_gold", "createmetallurgy:molten_gold");
  ...
  event.add(
    "createmetallurgy:molten_material",
...
ServerEvents.recipes((event) => {
  ...
  event.replaceInput(
    ...
    Ingredient.of("#c:storage_blocks/steel"),
  );
  event.replaceInput(
  ...
  event.replaceInput(
    { input: "petrochem:steel_ingot" },
    "petrochem:steel_ingot",
    Ingredient.of("#c:ingots/steel"),
  );
  event.replaceInput(
    { input: "petrochem:steel_sheet" },
    "petrochem:steel_sheet",
    Ingredient.of("#c:plates/steel"),
  );
  event.replaceInput(
    { input: "petrochem:steel_block" },
    "petrochem:steel_block",
    Ingredient.of("#c:storage_blocks/steel"),
  );
  event.replaceInput(
    { input: "createmetallurgy:steel_ingot" },
    "createmetallurgy:steel_ingot",
    Ingredient.of("#c:ingots/steel"),
  );
  event.replaceInput(
    { input: "createmetallurgy:steel_block" },
    "createmetallurgy:steel_block",
    Ingredient.of("#c:storage_blocks/steel"),
  );
  event.replaceInput(
    { input: "overgeared:steel_nugget" },
    "overgeared:steel_nugget",
    Ingredient.of("#c:nuggets/steel"),
  );
  event.replaceInput(
    { input: "overgeared:steel_ingot" },
    "overgeared:steel_ingot",
    Ingredient.of("#c:ingots/steel"),
  );
  event.replaceInput(
    { input: "overgeared:steel_block" },
    "overgeared:steel_block",
    Ingredient.of("#c:storage_blocks/steel"),
  );
  event.replaceInput(
    { input: "overgeared:steel_plate" },
    "overgeared:steel_plate",
    Ingredient.of("#c:plates/steel"),
  );

  event.replaceInput(
    { input: "createbigcannons:bronze_ingot" },
    "createbigcannons:bronze_ingot",
    Ingredient.of("#c:ingots/bronze"),
  );
  event.replaceInput(
    { input: "petrochem:bronze_ingot" },
    "petrochem:bronze_ingot",
    Ingredient.of("#c:ingots/bronze"),
  );
  ...
  event.replaceInput(
    { input: /gemsrealm:mc\/.*\/steel_nugget/ },
    /gemsrealm:mc\/.*\/steel_nugget/,
    Ingredient.of("#c:nuggets/steel"),
  );
  event.replaceInput(
    { input: /gemsrealm:mc\/.*\/bronze_nugget/ },
    /gemsrealm:mc\/.*\/bronze_nugget/,
    Ingredient.of("#c:nuggets/bronze"),
  );

  // Replace all fluid inputs by tags
  event.replaceInput(
    { input: Fluid.of("createbigcannons:molten_bronze") },
    Fluid.of("createbigcannons:molten_bronze"),
    "#c:fluids/molten_bronze",
  );
  event.replaceInput(
    { input: Fluid.of("createbigcannons:molten_steel") },
    Fluid.of("createbigcannons:molten_steel"),
    "#c:fluids/molten_steel",
  );
  event.replaceInput(
    { input: Fluid.of("createbigcannons:molten_cast_iron") },
    Fluid.of("createbigcannons:molten_cast_iron"),
    "#c:fluids/molten_cast_iron",
  );
  event.replaceInput(
    { input: Fluid.of("createbigcannons:molten_nethersteel") },
    Fluid.of("createbigcannons:molten_nethersteel"),
    "#c:fluids/molten_nethersteel",
  );
  event.replaceInput(
    { input: Fluid.of("createmetallurgy:molten_bronze") },
    Fluid.of("createbigcannons:molten_bronze"),
    "#c:fluids/molten_bronze",
  );
  event.replaceInput(
    { input: Fluid.of("createmetallurgy:molten_steel") },
    Fluid.of("createbigcannons:molten_steel"),
    "#c:fluids/molten_steel",
  );
  ...
  // Change steel plate output count
  event.remove({
    type: "overgeared:forging",
    output: "overgeared:steel_plate",
  });
  event.custom({
    type: "overgeared:forging",
    category: "misc",
  ...
  event.remove({ output: /gemsrealm:mc\/.*\/steel_sheet/ });
